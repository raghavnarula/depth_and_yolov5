...
class Parameters():
	def __init__(self):
		self.n_processors = 8
		# Path
		self.data_dir =  '/home/mononoke/.github/DeepVO-pytorch/KITTI/'
		self.img_dir = '/home/mononoke/GitUploads/depth_and_yolov5/final_results/2channel_PIL/'
		...
		self.batch_size = 1
		self.pin_mem = False
		self.optim = {'opt': 'Cosine', 'T': 100 , 'lr': 0.001} 
